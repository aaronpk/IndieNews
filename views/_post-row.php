<tr class="post post_<?= $this->post->id ?>">
  ...
  <td>
    ...
    <div class="details"><?= $this->post->domain ?> | <span class="points"><?= $this->post->points ?> point<?= $this->post->points == 1 ? '' : 's' ?></span> | <?= $this->post->date_submitted ?><!-- | <a href="/post/<?= $this->post->id ?>"><?= $this->post->comments ?> comment<?= $this->post->comments == 1 ? '' : 's' ?></a> --></div>
  </td>
</tr>
